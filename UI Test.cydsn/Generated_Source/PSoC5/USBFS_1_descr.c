...
* Config Descriptor  
*********************************************************************/
const uint8 CYCODE USBFS_1_DEVICE0_CONFIGURATION0_DESCR[34u] = {
...
*********************************************************************/
const uint8 CYCODE USBFS_1_STRING_DESCRIPTORS[39u] = {
/*********************************************************************
...
/*********************************************************************
* String Descriptor: "me"
*********************************************************************/
/* Descriptor Length                       */ 0x06u,
/* DescriptorType: STRING                  */ 0x03u,
 (uint8)'m', 0u,(uint8)'e', 0u,
/*********************************************************************
* String Descriptor: "keeb"
*********************************************************************/
/* Descriptor Length                       */ 0x0Au,
/* DescriptorType: STRING                  */ 0x03u,
 (uint8)'k', 0u,(uint8)'e', 0u,(uint8)'e', 0u,(uint8)'b', 0u,
/*********************************************************************
...
/*********************************************************************
* HID Report Descriptor: Keyboard w/LED Feature Report
*********************************************************************/
const uint8 CYCODE USBFS_1_HIDREPORT_DESCRIPTOR1[67u] = {
...
*********************************************************************/
T_USBFS_1_XFER_STATUS_BLOCK USBFS_1_DEVICE0_CONFIGURATION0_INTERFACE0_ALTERNATE0_HID_FEATURE_RPT_SCB;
uint8 USBFS_1_DEVICE0_CONFIGURATION0_INTERFACE0_ALTERNATE0_HID_FEATURE_BUF[
            USBFS_1_DEVICE0_CONFIGURATION0_INTERFACE0_ALTERNATE0_HID_FEATURE_BUF_SIZE];

/*********************************************************************
* HID Feature Report TD Table
*********************************************************************/
const T_USBFS_1_TD CYCODE USBFS_1_DEVICE0_CONFIGURATION0_INTERFACE0_ALTERNATE0_HID_FEATURE_RPT_TABLE[1u] = {
    {USBFS_1_DEVICE0_CONFIGURATION0_INTERFACE0_ALTERNATE0_HID_FEATURE_BUF_SIZE,
    &USBFS_1_DEVICE0_CONFIGURATION0_INTERFACE0_ALTERNATE0_HID_FEATURE_BUF[0u],
    &USBFS_1_DEVICE0_CONFIGURATION0_INTERFACE0_ALTERNATE0_HID_FEATURE_RPT_SCB},
};
/*********************************************************************
...
const T_USBFS_1_LUT CYCODE USBFS_1_DEVICE0_CONFIGURATION0_INTERFACE0_ALTERNATE0_HID_TABLE[5u] = {
    ...
    {0x00u,    NULL},
    {0x00u,     &USBFS_1_DEVICE0_CONFIGURATION0_INTERFACE0_ALTERNATE0_HID_FEATURE_RPT_TABLE},
