// ======================================================================
// Complete.v generated from TopDesign.cysch
// 05/04/2020 at 14:34
...
module emFile_v1_20_1 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("8ba891af-dec1-4404-b9bc-0dd70577f171/ed092b9b-d398-4703-be89-cebf998501f6"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("8ba891af-dec1-4404-b9bc-0dd70577f171/1425177d-0d0e-4468-8bcc-e638e5509a9b"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("8ba891af-dec1-4404-b9bc-0dd70577f171/ae249072-87dc-41aa-9405-888517aefa28"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("8ba891af-dec1-4404-b9bc-0dd70577f171/6df85302-e45f-45fb-97de-4bdf3128e07b"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
module top ;
	...
	wire [0:0] tmpOE__SDA_OLED_net;
	wire [0:0] tmpFB_0__SDA_OLED_net;
	wire [0:0] tmpINTERRUPT_0__SDA_OLED_net;
	electrical [0:0] tmpSIOVREF__SDA_OLED_net;

	cy_psoc3_pins_v1_10
		#(.id("98143743-9a55-461d-b950-b20fcaa019a5"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		SDA_OLED
		 (.oe(tmpOE__SDA_OLED_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__SDA_OLED_net[0:0]}),
		  .io({Net_37}),
		  .siovref(tmpSIOVREF__SDA_OLED_net),
		  .interrupt({tmpINTERRUPT_0__SDA_OLED_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SDA_OLED_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__SCL_OLED_net;
	wire [0:0] tmpFB_0__SCL_OLED_net;
	wire [0:0] tmpINTERRUPT_0__SCL_OLED_net;
	electrical [0:0] tmpSIOVREF__SCL_OLED_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("c180b8e2-396f-437e-9ae9-ef2ef95fa823"),
		  ...
		  .input_buffer_sel(2'b00))
		SCL_OLED
		 (.oe(tmpOE__SCL_OLED_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__SCL_OLED_net[0:0]}),
		  .io({Net_38}),
		  .siovref(tmpSIOVREF__SCL_OLED_net),
		  .interrupt({tmpINTERRUPT_0__SCL_OLED_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SCL_OLED_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
