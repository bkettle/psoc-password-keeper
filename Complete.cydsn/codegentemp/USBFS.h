...
#define USBFS_ENABLE_IDSN_STRING               
#define USBFS_ENABLE_STRINGS                   
#define USBFS_DEVICE0_CONFIGURATION0_INTERFACE3_ALTERNATE0_HID_IN_BUF_SIZE (9u)
#define USBFS_DEVICE0_CONFIGURATION0_INTERFACE3_ALTERNATE0_HID_NUM_IN_RPTS (1u)
#define USBFS_DEVICE0_CONFIGURATION0_INTERFACE3_ALTERNATE0_HID_OUT_BUF_SIZE (2u)
#define USBFS_DEVICE0_CONFIGURATION0_INTERFACE3_ALTERNATE0_HID_NUM_OUT_RPTS (1u)
#define USBFS_DEVICE0_CONFIGURATION0_INTERFACE3_ALTERNATE0_HID_COUNT (1u)
#define USBFS_ENABLE_HID_CLASS                 
#define USBFS_HID_RPT_1_SIZE_LSB               (0x41u)
...
#define USBFS_MAX_INTERFACES_NUMBER  (3u)
...
#define USBFS_EP5_ISR_REMOVE     (0u)
